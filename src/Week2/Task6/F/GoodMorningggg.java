 ...
 * Problem: <a href="https://open.kattis.com/problems/goodmorning">Good Morning!</a>
 * @author Hai Long Mac
 *
 * Method : Ad-Hoc
 * Status : Accepted
...
public class GoodMorningggg {
    ...
    public static void generate(int digit, int number) {
        ...
        if (digit == 1) {
            ...
            if (number <= 200) values.add(number);
            generate(1, number);
            generate(2, number);
            generate(4, number);
        }
